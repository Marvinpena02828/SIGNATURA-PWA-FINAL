...
// ===== CUSTOM SVG ICONS (RED & WHITE ONLY) - WITH COLOR PROP =====
...
const IntegrationIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="27.5" cy="37.5" r="2" fill={color}/>
    <circle cx="72.5" cy="37.5" r="2" fill={color}/>
  </svg>
);
...
const SupportIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="50" cy="70" r="1.5" fill={color}/>
  </svg>
);
...
const DataSecurityIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="20" y="25" width="60" height="50" rx="3" stroke={color} strokeWidth="2.5" fill="none"/>
    <path d="M20 35 L80 35" stroke={color} strokeWidth="2"/>
    <circle cx="30" cy="55" r="4" fill={color}/>
    <circle cx="50" cy="55" r="4" fill={color}/>
    <circle cx="70" cy="55" r="4" fill={color}/>
  </svg>
);

const MFAIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="15" y="30" width="70" height="45" rx="3" stroke={color} strokeWidth="2.5" fill="none"/>
    <circle cx="30" cy="52" r="6" stroke={color} strokeWidth="2" fill="none"/>
    <path d="M50 40 L60 52 L50 64 L40 52 Z" stroke={color} strokeWidth="2" fill="none"/>
    <circle cx="75" cy="52" r="6" stroke={color} strokeWidth="2" fill="none"/>
  </svg>
);

const BiometricIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="40" r="18" stroke={color} strokeWidth="2.5" fill="none"/>
    <path d="M50 20 L50 10" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M65 30 L72 20" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M70 50 L80 50" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M45 75 Q50 60 55 75" stroke={color} strokeWidth="2.5" fill="none" strokeLinecap="round"/>
  </svg>
);
...
const MonitoringIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="15" y="20" width="70" height="50" rx="3" stroke={color} strokeWidth="2.5" fill="none"/>
    <path d="M35 70 L65 70" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M45 70 L45 80" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M55 70 L55 80" stroke={color} strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M30 40 L50 35 L70 40" stroke={color} strokeWidth="2" fill="none" strokeLinecap="round"/>
  </svg>
);

const LedgerIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M30 20 L30 80 M50 20 L50 80 M70 20 L70 80" stroke={color} strokeWidth="2" opacity="0.6"/>
    <path d="M20 30 L80 30 M20 45 L80 45 M20 60 L80 60 M20 75 L80 75" stroke={color} strokeWidth="2" opacity="0.6"/>
...
const ZeroTrustIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="30" stroke={color} strokeWidth="2.5" fill="none"/>
    <circle cx="50" cy="50" r="20" stroke={color} strokeWidth="2" fill="none" opacity="0.6"/>
...
const BankingIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line x1="15" y1="60" x2="85" y2="60" stroke={color} strokeWidth="1.5" opacity="0.6"/>
    <line x1="30" y1="50" x2="30" y2="80" stroke={color} strokeWidth="1.5" opacity="0.6"/>
    <line x1="50" y1="50" x2="50" y2="80" stroke={color} strokeWidth="1.5" opacity="0.6"/>
    <line x1="70" y1="50" x2="70" y2="80" stroke={color} strokeWidth="1.5" opacity="0.6"/>
  </svg>
);
...
const GovernmentIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <line x1="30" y1="40" x2="70" y2="40" stroke={color} strokeWidth="1.5" opacity="0.6"/>
    <line x1="30" y1="55" x2="70" y2="55" stroke={color} strokeWidth="1.5" opacity="0.6"/>
    <line x1="30" y1="70" x2="70" y2="70" stroke={color} strokeWidth="1.5" opacity="0.6"/>
  </svg>
);
...
const EducationIcon = ({ size = 48, color = "#dc2626" }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M35 50 L35 70 M50 50 L50 70 M65 50 L65 70" stroke={color} strokeWidth="2" opacity="0.6"/>
          ...
          >
            {[
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                    <feature.icon size={72} color="white" />
                  </div>
